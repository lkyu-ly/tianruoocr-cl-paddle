...
def translate():
    ...
    if mod == "zh2en":
        result = pipe("zh2en:" + text, max_length=10240, num_beams=4)[0][
            "generated_text"
        ]
        return result
    elif mod == "en2zh":
        result = pipe("en2zh:" + text, max_length=10240, num_beams=4)[0][
            "generated_text"
        ]
        return result
    elif mod == "ja2zh":
        result = pipe("ja2zh:" + text, max_length=10240, num_beams=4)[0][
            "generated_text"
        ]
        return result
    elif mod == "zh2ja":
        result = pipe("zh2ja:" + text, max_length=10240, num_beams=4)[0][
            "generated_text"
        ]
        return result
